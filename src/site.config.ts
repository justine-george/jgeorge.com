...
export const experiences: Array<Experience> = [
	...
	},
	{
		...
		description:
			"In the Interest and Charges Team for Oracle FLEXCUBE Universal Banking, I built more than 30 RESTful APIs using Spring Boot and Spring Batch, improving service for over 900 global banks. I conducted over 350 code reviews, collaborating with cross-functional teams to enhance code reliability and product functionality, resulting in a 20% reduction in technical debt. Additionally, I engineered a Python-based automation tool for SQL entry generation, significantly optimizing database updates for a crucial financial module and reducing processing time by 95%. This tool was adopted across multiple teams. By optimizing our app's architecture, I reduced its Docker image size by 40%, enhancing deployment speed. Furthermore, I developed responsive UI components for a React-based SPA, increasing our page load speed by 60% and significantly boosting system performance.",
